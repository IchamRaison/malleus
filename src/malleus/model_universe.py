...
_PROVIDER_SPECS: tuple[ProviderSpec, ...] = (
    ...
    ProviderSpec(
        ...
        models=("nvidia/nemotron-mini-4b-instruct", "meta/llama-3.1-405b-instruct", "mistralai/mixtral-8x22b-instruct-v0.1"),
        adapter="nvidia",
        capabilities=("text",),
        verification_notes="NVIDIA API Catalog / NIM-style OpenAI-compatible endpoint.",
    ),
    ProviderSpec(
        ...
        verification_notes="OpenAI-compatible Moonshot/Kimi endpoint; live verification depends on user credentials.",
    ),
    ProviderSpec(
        provider_id="qwen",
        label="Alibaba Qwen",
        ...
        verification_notes="DashScope OpenAI-compatible endpoint; regional availability depends on the key.",
    ),
    ProviderSpec(
        provider_id="zhipu",
        label="Zhipu GLM",
        ...
        verification_notes="BigModel OpenAI-compatible endpoint; live verification depends on user credentials.",
    ),
    ProviderSpec(
